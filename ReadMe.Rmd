...
```{r, echo=F, message=F, warning=F}
Anova(lmer(ChangeSOS ~ TempAnom_2mo_sos + (1|site), data = filter(df_merge, check == "included", !is.na(ChangeSOS))  ))
Anova(lmer(Change_ndvi_max ~ TempAnom_5mo_max + (1|site), data = filter(df_merge, check == "included", !is.na(Change_ndvi_max))  ))
Anova(lmer(as.numeric(ChangeGSL) ~ TempAnom_5mo_max + (1|site), data = filter(df_merge, check == "included", !is.na(ChangeGSL))  ))

Anova(lmer(ChangeSOS ~ PrecipAnom_2mo_sos + (1|site), data = filter(df_merge, check == "included", !is.na(ChangeSOS))  ))
Anova(lmer(Change_ndvi_max ~ PrecipAnom_5mo_max + (1|site), data = filter(df_merge, check == "included", !is.na(Change_ndvi_max))  ))
Anova(lmer(as.numeric(ChangeGSL) ~ PrecipAnom_5mo_max + (1|site), data = filter(df_merge, check == "included", !is.na(ChangeGSL))  ))
