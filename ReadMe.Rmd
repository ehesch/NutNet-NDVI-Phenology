...
process_raw_climate <- TRUE #FALSE # TRUE
...
process_raw_ndvi <- TRUE #FALSE #TRUE

merge_climate_ndvi <- TRUE #FALSE #TRUE

create_final_df <- TRUE #FALSE #if this is TRUE, you will need to connect to dropbox
```
