...
} else print("not processing raw CLIMATE data")
```
...
2) Actually convert linear calendar years into circular data. Also filter the Landsat data to include only pixels identified as being "clear" or "snow" covered. Also we set the minimum NDVI to 0. 

```{r readinphenodata, eval = T, echo = F, message = F, warning = F}
pheno_path <- paste0(localdir, "/annoying manual")   # path to the data
